#!/usr/bin/env bash
# Master revert — undoes all three layers. Pass --purge to also delete installed files.
...
echo; echo "Revert complete for layers 2 & 3. Restart Qt apps to see changes."
